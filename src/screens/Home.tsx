...
import myCV from "../assets/CV_QA_Engineer_LeHuynhAnhTuyet.pdf";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative flex items-center justify-center z-30 order-1 md:order-2 w-full md:w-auto px-4 md:px-10">
          {/* SWITCH: MODE */}
          ...
          <div
            className="relative flex items-center justify-center w-[280px] h-[420px] lg:w-[350px] lg:h-[520px] transition-all duration-700 transform-gpu"
            style={{ filter: theme.portraitBorder }}
          >
            <div
              className="absolute inset-0 z-30 overflow-hidden shadow-2xl transform-gpu"
              style={{
            ...
            >
              <img
                ...
                style={{
                  transform: "translateX(-16px) translateZ(0) scale(1.02)",
                  filter: isLit
          ...
          {/* NAME CARD */}
          <div className="absolute bottom-1 right-[-0.5rem] md:bottom-2 md:right-[-1rem] z-10 rotate-6 transform-gpu transition-all hover:rotate-0 hover:scale-105 pointer-events-none">
            <div
